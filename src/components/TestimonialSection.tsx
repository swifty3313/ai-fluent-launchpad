    ...
    <section id="testimonials" className="section-padding bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="mb-4">Client <span className="text-gradient">Success Stories</span></h2>
          ...
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <div className="flex items-center">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-fsai-orange to-fsai-blue flex items-center justify-center text-white font-bold">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/4 mb-6 md:mb-0 flex justify-center">
              <div className="flex flex-col items-center">
                <div className="text-5xl font-bold text-fsai-orange">94%</div>
                <div className="text-gray-600 text-center mt-2">Productivity Improvement</div>
              </div>
            </div>
            
            <div className="w-full md:w-1/4 mb-6 md:mb-0 flex justify-center">
              <div className="flex flex-col items-center">
                <div className="text-5xl font-bold text-fsai-blue">3.5X</div>
                <div className="text-gray-600 text-center mt-2">ROI on Training</div>
              </div>
            </div>
            ...
            <div className="w-full md:w-1/4 mb-6 md:mb-0 flex justify-center">
              <div className="flex flex-col items-center">
                ...
                <div className="text-gray-600 text-center mt-2">Saved Per Week</div>
              </div>
            </div>
            ...
            <div className="w-full md:w-1/4 flex justify-center">
              <div className="flex flex-col items-center">
                ...
                <div className="text-gray-600 text-center mt-2">Client Satisfaction</div>
              </div>
            </div>
          </div>
        </div>
