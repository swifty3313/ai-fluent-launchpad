  ...
  const proCourses = [
    {
      ...
      lessons: 8,
      duration: "3 hours",
      gradient: "from-brand-beige to-gray-100"
    },
    {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden relative">
            <div className="absolute top-4 right-4 bg-brand-gold/20 text-brand-gold border border-brand-gold text-xs font-medium px-2 py-1 rounded-full flex items-center">
              <Star className="h-3 w-3 mr-1 fill-brand-gold stroke-brand-gold" />
              Most Popular
            </div>
            
            <div className="bg-gradient-to-r from-brand-gold/90 to-yellow-600 p-6">
            ...
            <div className="p-6">
                      ...
                      <div className="flex">
                        <div className="flex-shrink-0 mr-4">
                          <div className="w-10 h-10 rounded-full bg-brand-gold/20 flex items-center justify-center">
                            <span className="font-semibold text-brand-gold">{index + 4}</span>
                          </div>
                        </div>
                        <div>
                          <h4 className="font-semibold text-lg text-brand-gold">{course.title}</h4>
                          <p className="text-gray-600 mb-2">{course.description}</p>
                          <div className="flex text-sm text-gray-500">
                            <span className="mr-4">{course.lessons} lessons</span>
                            <span>{course.duration}</span>
              ...
              <div className="mt-8 mb-4">
                <div className="text-center mb-4">
                  <span className="text-2xl font-bold text-brand-gold">$297</span>
